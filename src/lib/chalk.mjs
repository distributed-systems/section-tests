// source: https://github.com/chalk/chalk/blob/master/index.js
import { stdout } from './supports-color.mjs';
import ansiStyles from './ansiStyles.mjs';
...
// source: https://github.com/sindresorhus/escape-string-regexp/blob/master/index.js
