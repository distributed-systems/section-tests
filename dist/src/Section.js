    ...
    */
    ...
    log(message, level = 'info') {
        if (this.sendLog)
            ...
            throw new Error('Cannot log message outside of a test, setup or destroyer routine!');
    }
    collectTransports(transports = []) {
        ...
        if (this.isRootSection())
            ...
            return this.getRoot().collectTransports(transports);
    }
    getInterface() {
    ...
    */
    ...
    test(...params) {
        ...
        params.forEach((param, index) => {
            if (type.object(param))
                options = param;
            else if (type.function(param))
                executeTest = param;
