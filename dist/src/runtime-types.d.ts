...
export type TestTeardown<TSetup = unknown> = ((setupResult: TSetup, context: TestContext) => void | Promise<void>) | TestTeardownWithoutSetup;
...
export type TestEvent = TestStartedEvent | TestPhaseEvent | TestLogEvent | TestTimeoutEvent | WorkerTerminatedEvent | TestFinishedEvent;
